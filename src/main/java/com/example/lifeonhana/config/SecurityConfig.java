...
public class SecurityConfig {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "https://life-on-hana-l280u7qzf-bbzjuns-projects.vercel.app","https://lifeonhana.topician.com")); // 프론트엔드 서버 주소
